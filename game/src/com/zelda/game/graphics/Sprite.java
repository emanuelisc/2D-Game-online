package com.zelda.game.graphics;
...
public class Sprite {
    ...
    private static com.zelda.game.graphics.Font currentFont;
    ...
    public static void drawArray(Graphics2D g, com.zelda.game.graphics.Font f, String word, Vector2f pos, int size, int xOffset) {
